...
extension SPARQLParserTests {
    static var allTests : [(String, (SPARQLParserTest) -> () throws -> Void)] {
        return [
            ...
            ("testBadReuseOfBlankNodeIdentifier1", testBadReuseOfBlankNodeIdentifier1),
            ("testBadReuseOfBlankNodeIdentifier2", testBadReuseOfBlankNodeIdentifier2),
            ("testBadReuseOfBlankNodeIdentifier3", testBadReuseOfBlankNodeIdentifier3),
            ("testBind", testBind),
            ...
            ("testLexerPropertyPath", testLexerPropertyPath),
