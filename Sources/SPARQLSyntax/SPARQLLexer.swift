...
public class SPARQLLexer: IteratorProtocol {
    ...
    private static let _keywordRegex: NSRegularExpression = {
        let windowKeywords = "OVER|PARTITION|RANGE|ROWS|BETWEEN|UNBOUNDED|PRECEDING|CURRENT|ROW|FOLLOWING|AND|RANK|ROW_NUMBER"
    ...
    internal static let validFunctionNames: Set<String> = {
        let windowKeywords = Set(["RANK", "ROW_NUMBER"])
