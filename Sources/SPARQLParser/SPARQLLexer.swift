...
public class SPARQLLexer: IteratorProtocol {
    ...
    // TODO: this shouldn't be public, but it's currently used by SPARQLSerializer.serializePretty in the Kineo package
    public static let validFunctionNames: Set<String> = {
